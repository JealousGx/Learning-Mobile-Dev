...
import { Bubble, type BubbleRef } from "./ballon";
...
export type AwesomeSliderProps = {
    ...
    /**
     * Label to be displayed above the slider.
     */
    label?: string;

    /**
     * Props for the label text component. Can be used to style the label.
     */
    labelProps?: React.ComponentProps<typeof Text>;

    /**
     * Props for the wrapper view component. Can be used to style the wrapper.
     */
    wrapperProps?: View["props"];

    /**
     * Whether the slider is required. If true, an asterisk will be displayed next to the label.
     */
    required?: boolean;
};
const defaultTheme: SliderThemeType = {
    minimumTrackTintColor: COLORS.dark.primary,
    maximumTrackTintColor: COLORS.dark.gray,
    cacheTrackTintColor: COLORS.dark.deepGray,
    bubbleBackgroundColor: COLORS.dark.primary,
    bubbleTextColor: COLORS.dark.white,
    heartbeatColor: COLORS.dark.lightGray,
};
        ...
        <View {...restWrapperProps} style={[styles.wrapper, wrapperStyle]}>
            ...
            <GestureDetector gesture={gesture}>
                <HitSlop {...panHitSlop}>
                    <Animated.View
                        testID={testID}
                        style={[styles.view, { height: Math.max(sliderHeight + 16, 32) }, style]}
                        hitSlop={panHitSlop}
                        onLayout={onLayout}
                    >
                        {renderContainer ? (
